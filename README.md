...
| — | GWRBoost | [arXiv](https://arxiv.org/abs/2212.05814) [GitHub](https://github.com/HanwGeek/GWRBoost) | Python Scripts | Primarily a prediction model. | Wang H, Huang Z, Yin G, et al. Gwrboost: a geographically weighted gradient boosting method for explainable quantification of spatially-varying relationships[J]. arXiv preprint arXiv:2212.05814, 2022. |
